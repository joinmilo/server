...
import app.milo.server.test.units.core.setup.entities.child.QTestChildEntity;
...
public class QTestEntity extends EntityPathBase<TestEntity> {
    ...
    public final app.milo.server.core.base.QBaseEntity _super = new app.milo.server.core.base.QBaseEntity(this);
