...
public class FriendApi extends CrudApi<FriendEntity, FriendService> {
  ...
  public PageableList<FriendEntity> readAll(
  ...
  public Optional<FriendEntity> readOne(
      @GraphQLArgument(name = CrudApi.entity) FriendEntity entity) {
    return super.readOne(entity);
  }

  @Override
  @GraphQLMutation(name = "saveFriends")
  public List<FriendEntity> saveAll(
      @GraphQLArgument(name = CrudApi.entities) List<FriendEntity> entities) {
