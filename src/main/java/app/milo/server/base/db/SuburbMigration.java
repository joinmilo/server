package app.milo.server.base.db;
...
import app.milo.server.core.location.BingMapService;
import app.milo.server.core.location.LocationConfiguration;
...
public class SuburbMigration implements CustomTaskChange {
  ...
  private String getLocationKey() {
    var place = System.getenv("MILO_LOCATION_KEY");
    ...
    if (place == null || place.isBlank()) {
      var message = "No location key found. Set either ENV MILO_LOCATION_KEY or VM argument -Dlocation.key";
  ...
  private String getPlace() {
    var location = System.getenv("MILO_LOCATION_CITY");
    ...
    if (location == null || location.isBlank()) {
      var message = "No location key found. Set either ENV MILO_LOCATION_CITY or VM argument -Dlocation.place";
      errors.addError(message);
    } else {
      return location;
    }
