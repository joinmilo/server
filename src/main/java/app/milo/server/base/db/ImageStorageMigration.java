...
import app.milo.server.core.media.base.MimeTypeService;
import app.milo.server.core.media.storage.DefaultStorageConfiguration;
import app.milo.server.core.media.storage.DefaultStorageService;
...
public class ImageStorageMigration implements CustomTaskChange {
  ...
  private String getWriteLocation() {
    var location = System.getenv("MILO_STORAGE_LOCATION");
    ...
    if (location == null || location.isBlank()) {
      var message = "No storage WRITE location found. Set either ENV MILO_STORAGE_LOCATION or VM argument -Dstorage.write-location";
