...
public class UserScheduler {
  ...
  public void deleteNotVerifiedUsers() {
    var notVerified = userService.readAll(userService.collectionQuery(userService.getPredicate().createdBefore(OffsetDateTime.now().minusDays(14)))
  ...
  public void deletePasswordResets() {
    var notReseted = passwordResetService.getCreatedBefore( 
