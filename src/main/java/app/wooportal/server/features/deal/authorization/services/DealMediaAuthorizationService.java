package app.wooportal.server.features.deal.authorization.services;
...
@Service
public class DealMediaAuthorizationService {
  
  private final UserContextAuthorizationService authorizationService;
  private final DealMediaService service;
  
  public DealMediaAuthorizationService(
      UserContextAuthorizationService authorizationService,
      DealMediaService service) {
