package app.wooportal.server.features.deal.components.category;
...
import app.wooportal.server.features.deal.components.category.translations.DealCategoryTranslatableEntity;
