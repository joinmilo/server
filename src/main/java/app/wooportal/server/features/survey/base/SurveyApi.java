...
@GraphQLApi
@Component
public class SurveyApi extends CrudApi<SurveyEntity, SurveyService> {


  public SurveyApi(SurveyService userService) {
    super(userService);
  }

  @Override
  @GraphQLQuery(name = "getSurveys")
  public PageableList<SurveyEntity> readAll(
  ...
  public SurveyEntity saveOne(@GraphQLArgument(name = CrudApi.entity) SurveyEntity entity) {
